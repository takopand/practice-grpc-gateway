...
const (
	HelloWorld_GetHelloWorld_FullMethodName = "/hello.HelloWorld/GetHelloWorld"
)
...
func (c *helloWorldClient) GetHelloWorld(ctx context.Context, in *HelloWorldRequest, opts ...grpc.CallOption) (*HelloWorldResponse, error) {
...
func (UnimplementedHelloWorldServer) GetHelloWorld(context.Context, *HelloWorldRequest) (*HelloWorldResponse, error) {
...
func _HelloWorld_GetHelloWorld_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HelloWorldServer).GetHelloWorld(ctx, req.(*HelloWorldRequest))
	}
